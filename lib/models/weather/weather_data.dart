...
import 'package:weatherapi/models/temperature.dart';
...
class WeatherData {
  ...
  factory WeatherData.from(Weather weather) {
    return WeatherData(
        ...
        minTemp: Temperature.celsius(weather.weatherParams.tempMix),
        maxTemp: Temperature.celsius(weather.weatherParams.tempMax),
        description: weather.weatherInfo[0].main,
        date: DateTime.fromMicrosecondsSinceEpoch(weather.dt * 1000),
