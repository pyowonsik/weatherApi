...
mixin _$WeatherParams {
  ...
  double get tempMix => throw _privateConstructorUsedError;
...
abstract class $WeatherParamsCopyWith<$Res> {
  ...
  $Res call(
      {double temp,
      @JsonKey(name: 'temp_min') double tempMix,
    ...
    return _then(_value.copyWith(
      temp: temp == freezed
          ...
          : temp // ignore: cast_nullable_to_non_nullable
              as double,
      tempMix: tempMix == freezed
          ? _value.tempMix
          : tempMix // ignore: cast_nullable_to_non_nullable
              as double,
...
class __$$_WeatherParamsCopyWithImpl<$Res>
  ...
  __$$_WeatherParamsCopyWithImpl(
      ...
      : super(_value, (v) => _then(v as _$_WeatherParams));

  @override
  _$_WeatherParams get _value => super._value as _$_WeatherParams;
...
class _$_WeatherParams implements _WeatherParams {
  _$_WeatherParams(
      {required this.temp,
      @JsonKey(name: 'temp_min') required this.tempMix,
  ...
  @override
  String toString() {
    return 'WeatherParams(temp: $temp, tempMix: $tempMix, tempMax: $tempMax)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.tempMix, tempMix) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(tempMix),
...
abstract class _WeatherParams implements WeatherParams {
  factory _WeatherParams(
          ...
          @JsonKey(name: 'temp_min') required final double tempMix,
...
/// @nodoc
class __$$_WeatherInfoCopyWithImpl<$Res> extends _$WeatherInfoCopyWithImpl<$Res>
    implements _$$_WeatherInfoCopyWith<$Res> {
  __$$_WeatherInfoCopyWithImpl(
      _$_WeatherInfo _value, $Res Function(_$_WeatherInfo) _then)
      : super(_value, (v) => _then(v as _$_WeatherInfo));

  @override
  _$_WeatherInfo get _value => super._value as _$_WeatherInfo;
